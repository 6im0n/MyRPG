...
static int items_loaders[I_LEN][IS_LEN] = {
    ...
    [I_AXE_LEV3][IS_STRENGHT] = 3,
    [I_AXE_LEV3][IS_RESISTANCE] = 3,
    [I_AXE_LEV4][IS_SPEED] = -2,
    [I_AXE_LEV4][IS_STRENGHT] = 4,
